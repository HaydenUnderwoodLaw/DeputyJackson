...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('recwarningia')
		.setDescription('Logs recorded warning from Military Investgation Service')
...
const username = interaction.options.getString("username")
        ...
        .setDescription(`**${username}** has recieved a **recorded warning** as a result of an MIS Investigation`)
		.setColor("Red")
