...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('demote')
		.setDescription('Logs demotion')
        .addStringOption((option) => option.setName('username').setDescription('Username of the individual?').setRequired(true))
        .addStringOption(option => option.setName('rank').setDescription(`What is the rank you're demoting the individual to?`).setRequired(true)),
